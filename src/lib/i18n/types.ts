...
export interface Messages {
  ...
  adminHolidays: {
    ...
    endAcademicYearDesc: string;
    dayOfWeek: string;
    dayOfMonth: string;
    monthOfYear: string;
    selectMonth: string;
    customDates: string;
    addCustomDate: string;
    tagLabel: string;
    selectTag: string;
    manageTags: string;
    tagName: string;
    ...
    pauseStreaks: string;
    pauseStreaksDesc: string;
    pauseAttendance: string;
    pauseAttendanceDesc: string;
    hideCheckin: string;
    hideCheckinDesc: string;
    showBanner: string;
    showBannerDesc: string;
    ...
    successAddRule: string;
    successUpdateRule: string;
    successDeleteRule: string;
    successAddTag: string;
    successDeleteTag: string;
    noRules: string;
    noTags: string;
    dayMon: string;
    dayTue: string;
